...
export function LeftSidebar() {
  ...
  const topLeagues = [
    { id: 39, name: 'Premier League', country: 'England', logo: '/leagues/39.png' },
    { id: 140, name: 'La Liga', country: 'Spain', logo: '/leagues/140.png' },
    { id: 135, name: 'Serie A', country: 'Italy', logo: '/leagues/135.png' },
    { id: 78, name: 'Bundesliga', country: 'Germany', logo: '/leagues/78.png' },
    { id: 61, name: 'Ligue 1', country: 'France', logo: '/leagues/61.png' },
  ]
