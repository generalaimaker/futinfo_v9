...
export default function CommunityPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50/50 dark:from-black dark:via-gray-950 dark:to-black lg:ml-64 pb-16 md:pb-0 overflow-x-hidden">
      {/* Apple-style Header with Blur */}
      <header className="sticky top-16 z-30 bg-white/70 dark:bg-gray-950/70 backdrop-blur-2xl border-b border-gray-200/30 dark:border-gray-800/30">
          ...
          <div className="flex items-center justify-between h-14 md:h-16">
            <div className="flex items-center gap-2 md:gap-4">
              <motion.h1 
                ...
                className="text-xl md:text-3xl font-semibold text-gray-900 dark:text-white tracking-tight"
              >
                락커룸
              </motion.h1>
              <motion.div
            ...
            >
              <Button 
                variant="ghost" 
                size="icon"
                className="rounded-full hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-all h-8 w-8 md:h-10 md:w-10"
              >
              ...
              <Button 
                variant="ghost" 
                size="icon"
                className="rounded-full hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-all relative h-8 w-8 md:h-10 md:w-10"
              >
                <Bell className="h-4 w-4 md:h-5 md:w-5" />
                <span className="absolute top-1 right-1 md:top-2 md:right-2 w-1.5 h-1.5 md:w-2 md:h-2 bg-red-500 rounded-full animate-pulse" />
              </Button>
              {user && (
                <Link href="/community/boards/all/write" className="hidden sm:block">
                  <Button className="rounded-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white shadow-lg shadow-blue-500/25 transition-all hover:shadow-xl hover:shadow-purple-500/25 text-sm md:text-base">
      ...
      <div className="px-4 md:container md:mx-auto py-4 md:py-8">
        <div className="grid lg:grid-cols-3 gap-4 md:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 md:space-y-8">
            ...
            <motion.div
              ...
              className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl md:rounded-3xl shadow-lg md:shadow-2xl shadow-gray-200/50 dark:shadow-black/50 border border-gray-200/50 dark:border-gray-800/50 overflow-hidden"
            >
              {/* Gradient Header */}
              <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4 md:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div className="flex items-center gap-2 md:gap-3">
                    <div className="p-2 md:p-2.5 rounded-xl md:rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg">
                      <Hash className="h-4 w-4 md:h-5 md:w-5 text-blue-600 dark:text-blue-400" />
                    </div>
                  ...
                  <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl md:rounded-2xl p-1 shadow-inner">
                    <div className="flex gap-1">
                      <button
                        onClick={() => setSelectedCategory('boards')}
                        className={cn(
                          "px-3 md:px-4 py-1.5 md:py-2 rounded-lg md:rounded-xl text-xs md:text-sm font-medium transition-all",
                      ...
                      {boardCategories.map((category, index) => (
                        ...
                        >
                          <Link href={`/community/boards/${category.id}`}>
                            <div className={cn(
                              "relative overflow-hidden rounded-xl md:rounded-2xl transition-all duration-300",
                              "bg-gradient-to-br shadow-md md:shadow-lg hover:shadow-lg md:hover:shadow-xl",
                              category.bg,
                              ...
                              <div className="relative p-4 md:p-6">
                                <div className="flex items-start gap-3 md:gap-4">
                                  <motion.div 
                                    className={cn(
                                      "p-2.5 md:p-3 rounded-xl md:rounded-2xl bg-gradient-to-br text-white shadow-lg",
                                      category.color
                                    )}
                                  ...
                                  <div className="flex-1">
                                    <h3 className="font-semibold text-base md:text-lg text-gray-900 dark:text-white mb-1">
                                      {category.name}
                                    </h3>
                      ...
                      {popularTeams.map((team, index) => (
                        ...
                        >
                          <Link href={`/community/boards/team_${team.id}`}>
                            <div className="group relative overflow-hidden rounded-xl md:rounded-2xl bg-white dark:bg-gray-900 shadow-md md:shadow-lg hover:shadow-lg md:hover:shadow-2xl transition-all duration-300 border border-gray-200/50 dark:border-gray-800/50">
                              {/* Gradient Background */}
                              <div className={cn(
                                ...
                                <div className="flex flex-col items-center text-center">
                                  ...
                                  <div className="relative mb-3 md:mb-4">
                                    ...
                                    <Image
                                      ...
                                      width={48}
                                      height={48}
                                      className="relative z-10 drop-shadow-xl md:w-14 md:h-14"
                                    />
                                  </div>
                                  
                                  <h3 className="font-semibold text-sm md:text-base text-gray-900 dark:text-white mb-2">
                                    {team.name}
                                  </h3>
                                  
                                  <div className="flex items-center gap-1 md:gap-1.5 text-[10px] md:text-xs text-gray-500 dark:text-gray-400 mb-2 md:mb-3">
                                    <Users className="h-3 w-3 md:h-3.5 md:w-3.5" />
                                    <span className="font-medium">{team.members}</span>
                                    <span>팬</span>
                                  </div>
                                  
                                  <Badge className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 text-green-700 dark:text-green-400 border-green-200/50 dark:border-green-800/50 text-[10px] md:text-xs py-0.5 px-1.5">
            ...
            >
              ...
              <div className="bg-gradient-to-r from-orange-50 via-red-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4 md:p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 md:gap-3">
                    <div className="p-2 md:p-2.5 rounded-xl md:rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg">
                  ...
                  <Link href="/community/boards/hot">
                    <Button variant="ghost" size="sm" className="rounded-full hover:bg-white/50 dark:hover:bg-gray-800/50 text-xs md:text-sm">
                      전체보기
                ...
                {isLoading ? (
                  ...
                  posts.slice(0, 5).map((post, index) => (
                    ...
                    >
                      ...
                      <div className="p-3 md:p-5 pl-6 md:pl-8 flex items-start gap-3 md:gap-4">
                        {/* Rank Badge */}
                        <div className="flex-shrink-0 hidden sm:block">
                          <div className={cn(
                            "w-8 h-8 md:w-10 md:h-10 rounded-xl md:rounded-2xl flex items-center justify-center font-bold shadow-lg text-sm md:text-base",
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-medium text-sm md:text-base text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors line-clamp-1 mb-1">
                            {post.title}
                          </h3>
                          <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 line-clamp-2 mb-2 md:mb-3">
                            {post.content}
                          </p>
                          ...
                          <div className="flex flex-wrap items-center gap-2 md:gap-4 text-[10px] md:text-xs">
                            <div className="flex items-center gap-1 md:gap-2">
                              <Avatar className="w-4 h-4 md:w-5 md:h-5">
                                <AvatarFallback className="text-[8px] md:text-[10px] bg-gradient-to-br from-blue-500 to-purple-500 text-white">
          ...
          {/* 사이드바 - Apple Widget Style - 모바일에서는 숨김 */}
